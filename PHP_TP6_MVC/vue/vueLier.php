<?php
    ...
    $contenu = '<form action="?action=ValideLier2" method="post">';
    ...
    $contenu .= '<input type="hidden" name="lientuteur" id=lientuteur" value="' .$_SESSION['idtuteur']. '">';
    ...
    $contenu .= '<input type="submit" name="ValideLier2" id="ValideLier2" value="VALIDEZ"> <br><br>';
